...
No Arbitrary Downloads: Do not use wget or curl to pull files directly into the repository unless the source is explicitly verified as safe.
...
Memory Guarding: Do not log raw API tokens, authorization headers, or private customer data to the terminal standard output or to unencrypted local debug log files.
